<template>
    <TheContainer>
        <div class="space-y-6">
            ...
            <div v-else-if="tasksStore.tasks.length === 0" class="text-center py-8">\white rounded-lg shadow-sm p-6
                ...
                <CardContent>
                    <div class="space-y-4">
                        ...
                        <div v-else class="space-y-3">
                            <div v-for="task in tasksStore.tasks.slice(0, 5)" :key="task.id"
...
const loadDashboardData = async () => {
    try {
        await tasksStore.fetchTasks({ limit: 5 }) // Buscar apenas 5 tarefas para o dashboard
    } catch (error) {
